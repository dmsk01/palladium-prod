 ...
 */
    ...
    (() => {
        ...
        window.onload = function() {
            document.addEventListener("click", workCases);
            function workCases(e) {
                const clickedElem = e.target;
                if (window.innerWidth < 991.98) {
                    if (clickedElem.classList.contains("cases__type-name")) clickedElem.closest(".cases__group").classList.toggle("_active");
                    if (clickedElem.closest(".cases__group") && clickedElem.classList.contains("cases__title")) removeClasses(document.querySelectorAll(".cases__group._active"), "_active");
                    if (!clickedElem.closest(".cases__group") && document.querySelectorAll(".cases__group._active").length > 0) removeClasses(document.querySelectorAll(".cases__group._active"), "_active");
                }
            }
        };
        ...
        function initSliders() {
            ...
            if (document.querySelector(".catalog-swiper")) new core(".catalog-swiper", {
            ...
            if (document.querySelector(".facade-swiper")) new core(".facade-swiper", {
                modules: [ Navigation, Pagination, EffectFade ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            for (let caseSlider = 0; caseSlider < caseSliders.length; caseSlider++) {
                ...
                const elementPrevButton = caseBody.querySelector(".case-swiper-button-prev");
                const elementNextButton = caseBody.querySelector(".case-swiper-button-next");
